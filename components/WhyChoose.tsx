...
const WhyChoose = () => {
  ...
  return (
    <>
    <div className="flex justify-center items-center flex-col gap-2 mt-8">
    ...
    <div className="container flex flex-col flex-wrap md:flex-row justify-evenly items-center mt-5">
            <ServiceCard
